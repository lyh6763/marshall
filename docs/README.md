...
- 공식 페이지로 연결되는 CTA/푸터/소셜 링크 정리
- 콘텐츠 이미지 `picture/img` 전환, alt, lazy loading, srcset/sizes, WebP/AVIF 적용
...
- 개선 포인트: 모바일 메뉴 접근성, 제품 이미지 비율, 섹션 간 여백 리듬, 푸터 아코디언 상태 동기화, CTA 목적성, 이미지 접근성
