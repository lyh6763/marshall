...
- 브랜드 무드를 해치지 않으면서 정보 구조를 원페이지 흐름으로 재설계했습니다.
- 모바일 메뉴, 푸터 아코디언, 반복 CTA를 키보드/스크린리더 관점에서 보완했습니다.
- 콘텐츠 이미지를 `picture/img` 구조로 전환해 접근성, 반응형 로딩, WebP/AVIF 성능 개선을 함께 반영했습니다.
- 문서와 코드 리뷰 자료를 함께 정리해 구현 의도와 검증 과정을 설명할 수 있도록 구성했습니다.
